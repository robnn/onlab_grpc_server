...
public final class InstituteServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<grpc.generated.InstituteId,
      grpc.generated.Institute> METHOD_GET_INSTITUTEBY_ID =
      io.grpc.MethodDescriptor.<grpc.generated.InstituteId, grpc.generated.Institute>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<grpc.generated.Empty,
      grpc.generated.InstituteList> METHOD_GET_ALL_INSTITUTES =
      io.grpc.MethodDescriptor.<grpc.generated.Empty, grpc.generated.InstituteList>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
          ...
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.generated.InstituteList.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<grpc.generated.Institute,
      grpc.generated.Empty> METHOD_ADD_INSTITUTE =
      io.grpc.MethodDescriptor.<grpc.generated.Institute, grpc.generated.Empty>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class InstituteServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getInstitutebyId(grpc.generated.InstituteId request,
        io.grpc.stub.StreamObserver<grpc.generated.Institute> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_INSTITUTEBY_ID, responseObserver);
    }

    /**
     */
    public void getAllInstitutes(grpc.generated.Empty request,
        io.grpc.stub.StreamObserver<grpc.generated.InstituteList> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_ALL_INSTITUTES, responseObserver);
    }

    /**
     */
    public void addInstitute(grpc.generated.Institute request,
  ...
  public static final class InstituteServiceBlockingStub extends io.grpc.stub.AbstractStub<InstituteServiceBlockingStub> {
    ...
    /**
     */
    public grpc.generated.Institute getInstitutebyId(grpc.generated.InstituteId request) {
    ...
    /**
     */
    public grpc.generated.InstituteList getAllInstitutes(grpc.generated.Empty request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public grpc.generated.Empty addInstitute(grpc.generated.Institute request) {
      return blockingUnaryCall(
  ...
  public static final class InstituteServiceFutureStub extends io.grpc.stub.AbstractStub<InstituteServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.generated.Institute> getInstitutebyId(
        grpc.generated.InstituteId request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.generated.InstituteList> getAllInstitutes(
        grpc.generated.Empty request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.generated.Empty> addInstitute(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_INSTITUTEBY_ID:
          serviceImpl.getInstitutebyId((grpc.generated.InstituteId) request,
              (io.grpc.stub.StreamObserver<grpc.generated.Institute>) responseObserver);
          break;
        case METHODID_GET_ALL_INSTITUTES:
          serviceImpl.getAllInstitutes((grpc.generated.Empty) request,
              (io.grpc.stub.StreamObserver<grpc.generated.InstituteList>) responseObserver);
          break;
        case METHODID_ADD_INSTITUTE:
          serviceImpl.addInstitute((grpc.generated.Institute) request,
              (io.grpc.stub.StreamObserver<grpc.generated.Empty>) responseObserver);
          break;
        default:
