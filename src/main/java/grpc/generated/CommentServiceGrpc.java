...
public final class CommentServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<grpc.generated.Subject,
      grpc.generated.CommentList> METHOD_GET_COMMENTS_BY_SUBJECT =
      io.grpc.MethodDescriptor.<grpc.generated.Subject, grpc.generated.CommentList>newBuilder()
          ...
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.generated.CommentList.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<grpc.generated.Comment,
      grpc.generated.Empty> METHOD_ADD_COMMENT =
      io.grpc.MethodDescriptor.<grpc.generated.Comment, grpc.generated.Empty>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "CommentService", "addComment"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.generated.Comment.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class CommentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCommentsBySubject(grpc.generated.Subject request,
        io.grpc.stub.StreamObserver<grpc.generated.CommentList> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_COMMENTS_BY_SUBJECT, responseObserver);
    }

    /**
     */
    public void addComment(grpc.generated.Comment request,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                grpc.generated.CommentList>(
                  this, METHODID_GET_COMMENTS_BY_SUBJECT)))
          .addMethod(
            METHOD_ADD_COMMENT,
            asyncUnaryCall(
              new MethodHandlers<
                grpc.generated.Comment,
  ...
  public static final class CommentServiceBlockingStub extends io.grpc.stub.AbstractStub<CommentServiceBlockingStub> {
    ...
    /**
     */
    public grpc.generated.CommentList getCommentsBySubject(grpc.generated.Subject request) {
    ...
    /**
     */
    public grpc.generated.Empty addComment(grpc.generated.Comment request) {
      return blockingUnaryCall(
  ...
  public static final class CommentServiceFutureStub extends io.grpc.stub.AbstractStub<CommentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.generated.CommentList> getCommentsBySubject(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.generated.Empty> addComment(
        grpc.generated.Comment request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_COMMENTS_BY_SUBJECT:
          serviceImpl.getCommentsBySubject((grpc.generated.Subject) request,
              (io.grpc.stub.StreamObserver<grpc.generated.CommentList>) responseObserver);
          break;
        case METHODID_ADD_COMMENT:
          serviceImpl.addComment((grpc.generated.Comment) request,
              (io.grpc.stub.StreamObserver<grpc.generated.Empty>) responseObserver);
          break;
        default:
